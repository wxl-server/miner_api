...
require (
	...
	github.com/wxl-server/idl_gen v0.0.0-20250412213807-78a607aed666
...
require (
	...
	github.com/cloudwego/kitex/pkg/protocol/bthrift v0.0.0-20250411071612-9ba8fdc7ec79 // indirect
